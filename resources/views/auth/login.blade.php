  ...
  <div class="login-box-body" style="border: 2px solid #000; box-shadow: 2px 5px 7px #999;">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group has-feedback">
                <input id="username" type="text" class="form-control sty1 @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
        ...
        <div class="form-group has-feedback">
                ...
                <input id="password" type="password" class="form-control sty1 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
